...
public class MapsActivityDriver extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                nm = number.getText().toString().trim();
                    ...
                    if (l != null) {
                        ...
                        Toast.makeText(MapsActivityDriver.this, "UPDATED", Toast.LENGTH_SHORT).show();

                        Intent intent = new Intent(MapsActivityDriver.this, MapsActivityDriver.class);
